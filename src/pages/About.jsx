    ...
    <div className="w-full">
      ...
      <div className='w-full mb-10'>
        <div className='w-[60%] mx-auto flex items-center flex-col'>
          <h1 className='text-secondary font-bold text-[16px] md:text-[20px] lg:text-[26px] title-cus relative text-center uppercase'>Thành Viên</h1>
          <h1 className='text-[26px] lg:text-[47px] uppercase font-bold text-primary'>tìm hiểu về <span className='text-secondary'>các thành viên</span></h1>
        </div>
        <div className='w-[80%] mx-auto grid grid-cols-12 gap-3 mt-10'>
          {listMember.map(item => (
            <div key={item.fullName} className='col-span-12 md:col-span-6 lg:col-span-4 shadow-lg pb-4 my-3'>
            <div className='w-full relative'>
              <img src={item.img} className='w-full max-h-[400px] object-cover' alt="" />
            ...
            <p className='text-primary text-[25px] text-center mt-7'>{item.fullName}</p>
