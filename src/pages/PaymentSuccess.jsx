    ...
    <div className="w-full min-h-screen">
      <div className="w-full md:w-[70%] h-[460px] mx-auto mt-5 flex items-start rounded-md overflow-hidden shadow-lg">
        <div className="w-full md:w-[40%] bg-[#af206f] px-2 h-full flex flex-col justify-around items-center">
          <p className="text-white text-center my-2">Nhà cung cấp <br /> &ensp; &ensp; &ensp; &ensp; <span className="font-bold">Momo Payment</span></p>
          <div className="line"></div>
          <p className="text-white text-center my-2">Số tiền <br /> &ensp; &ensp; &ensp; &ensp;
            <span className="font-bold">
              {amount}
            </span></p>
          <div className="line"></div>
          <p className="text-white text-center my-2">Thông tin <br /> &ensp; &ensp; &ensp; &ensp; <span className="font-bold">{orderInfo}</span></p>
          <div className="line"></div>
          <p className="text-white text-center my-2">Đơn hàng <br /> &ensp; &ensp; &ensp; &ensp;
            <span className="font-bold">
              {orderType} <br />
              {orderId}
            </span></p>
        ...
        <div className="w-full md:w-[60%]">
          <div className='w-full justify-between items-center px-2 hidden lg:flex'>
            ...
            <img className='w-[70px] h-[70px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDK-HgXPh9osISQTLAHVdO3foi-FY3IOmbbAyr-TbKHwMI3lwllKDjBoS_N1ZipoMhusY&usqp=CAU" alt="" />
          </div>
